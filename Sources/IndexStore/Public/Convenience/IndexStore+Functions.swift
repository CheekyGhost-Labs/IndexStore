...
public extension IndexStore {
    ...
    /// Will return the source symbols for any function declarations/symbols within the store that match the given query.
    ///
    ...
    /// Will return the source symbols for any function declarations/symbols within the given source files.
    ///
    ...
    /// Will return the source symbols for any function declarations/symbols within the store.
    ///
